...
const NavBar =({toggle,setToggle,username,setUsername,toggleAddpop,setToggleAddpop}) => {
...
rounded-md ${theme ? "placeholder-white bg-red-400 cursor-text hover:bg-slate-50 text-black focus-within:bg-white":"bg-black text-white"} `}>
                </input>
            </li>
        </ul>
