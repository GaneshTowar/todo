  ...
  return (
    <nav className='flex justify-between py-4'>
                ...
                <div className='flex mx-12 gap-6 cursor-pointer'>
                    ...
                    <div className='hover:bg-slate-200 rounded-md border-l-2 p-2' onClick={()=>navi("/home/inbox")}>Log in</div>
                    <div className='bg-red-500 text-white font-bold rounded-lg p-2 hover:bg-red-600' onClick={()=>navi("/home/inbox")}>Start for free</div>
                </div>
            </nav>
  )
}
